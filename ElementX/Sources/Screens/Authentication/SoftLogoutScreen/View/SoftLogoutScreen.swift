...
struct SoftLogoutScreen: View {
    ...
    var header: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text(UntranslatedL10n.softLogoutSigninNotice(context.viewState.credentials.homeserverName, context.viewState.credentials.userDisplayName, context.viewState.credentials.userID.matrixIDLocalpart))
